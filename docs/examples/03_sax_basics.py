...
# We could do the same thing for our individual components

mzi2x2_netlist = mzi2x2_2x2().get_netlist()
...
# This is equivalent to extract a netlist recursively to the lower element levels on our component

recursive_netlist = switch_circuit.get_netlist_recursive()
recursive_netlist["component_lattice_generic"]["instances"].keys()
