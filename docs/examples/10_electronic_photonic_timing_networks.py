...
# Part of the desired functionality in `piel` is to be able to understand these timing networks in relation to existing component definitions. Each `Connection` has a `time` definition which is defined as `TimeMetric`.
...
# ```
# Connection(name='', attrs={}, connection=[Port(name='', attrs={}, parent_component_name=''), Port(name='', attrs={}, parent_component_name='')], time=TimeMetric(name='', attrs={}, value=0, mean=0, min=0, max=0, standard_deviation=0))
# ```
...
basic_timing = piel.types.TimeMetric(value=1)
...
# ```python
# CoaxialCable(name='example_cable', attrs={}, connection=[PhysicalPort(name='in', attrs={}, parent_component_name='', domain=None, connector='', manifold=''), PhysicalPort(name='out', attrs={}, parent_component_name='', domain=None, connector='', manifold='')], connections=[PhysicalConnection(connections=[Connection(name='', attrs={}, connection=[PhysicalPort(name='in', attrs={}, parent_component_name='', domain=None, connector='', manifold=''), PhysicalPort(name='out', attrs={}, parent_component_name='', domain=None, connector='', manifold='')], time=TimeMetric(name='', attrs={}, value=0, mean=0, min=0, max=0, standard_deviation=0, unit=Unit(name='second', datum='second', base=1)))], components=[])], components=[], environment=Environment(temperature_K=None, region=None), manufacturer='', model='', network=None, metrics=FrequencyMetricCollection(bandwidth_Hz=ScalarMetric(name='', attrs={}, value=None, mean=None, min=None, max=None, standard_deviation=None, unit=Unit(name='ratio', datum='1', base=1)), center_transmission_dB=ScalarMetric(name='', attrs={}, value=None, mean=None, min=None, max=None, standard_deviation=None, unit=Unit(name='ratio', datum='1', base=1))), geometry=CoaxialCableGeometryType(units=None, core_cross_sectional_area_m2=3.141592653589793e-06, length_m=1.0, sheath_cross_sectional_area_m2=4.482872075095052e-07, total_cross_sectional_area_m2=3.5898798610992983e-06), heat_transfer=CoaxialCableHeatTransferType(units='W', core=0, sheath=0, dielectric=0, total=0.0), material_specification=None)
# ```
