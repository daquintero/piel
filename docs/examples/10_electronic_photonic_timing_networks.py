...
# ```
# Connection(name='', attrs={}, ports=[Port(name='', attrs={}, parent_component_name=''), Port(name='', attrs={}, parent_component_name='')], time=TimeMetric(name='', attrs={}, value=0, mean=0, min=0, max=0, standard_deviation=0))
# ```
