...
#
# latest_design_run_directory = piel.tools.openlane.find_latest_design_run(
...
#
# inverter_component = piel.integration.create_gdsfactory_component_from_openlane(
#     design_directory="./designs" / piel.return_path("inverter"),
# )
#
...
#
# latest_run_output = piel.tools.openlane.find_latest_design_run(
#     design_directory="./designs" / piel.return_path("inverter"),
# )
# latest_run_output
#
