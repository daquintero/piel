...
from .via_stack import via_stack_heater_mtop
from .taper import taper as electric_taper
...
def straight_heater_metal_undercut(
    ...
    if via_stack:
        via = via_stackw = via_stacke = via_stack_heater_mtop()
