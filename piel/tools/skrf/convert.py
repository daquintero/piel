...
def convert_skrf_network_to_network_transmission(network) -> NetworkTransmission:
    ...
    for i in range(num_ports):
        for j in range(num_ports):
            ...
            path_transmission = PathTransmission(ports=port_map, transmission=phasor)
...
#         raise ValueError(f"input_port {input_port} is out of range for a network with {network.nports} ports.")
#
#     # Extract frequency data
